...
def test_generate_previous_positions():
    ...
    poslist1 = [
        '1r1gk/P4/5/3+s+r/KG3[Pbbs] b 0 0',
        'r2gk/P4/5/4+r/KGs2[Pbbs] b 0 0',
        'r2gk/P4/5/3S+r/KGs2[Pbb] b 0 0',
        'r2gk/P4/5/3+S+r/KGs2[Pbb] b 0 0',
    ]
    #print(f'poslist={poslist}')
    for pos1 in poslist1:
        assert pos1 in poslist
    pos = Position('+P2gk/5/5/3+s+r/KG3[RPbbs] b 0 2')
    poslist = [pos1.fen() for pos1 in generate_previous_positions(pos)]
    poslist1 = [
        'r2gk/P4/5/3+s+r/KG3[Pbbs] w 0 1',
    ]
    #print(f'poslist={poslist}')
    for pos1 in poslist1:
        assert pos1 in poslist
def test_do_undo():
    posstr = 'r2gk/P4/5/3+s+r/KG3[Pbbs] w 0 1'
    pos = Position(posstr)
